...
func addACDrive(c *cli.Context) error {
	loadChasm(c)
	var acdrive ACDriveStore

	if (&acdrive).Setup() == false {
		color.Red("(Cloud Store) Amazon Cloud Drive: setup incomplete.")
		return nil
	}
